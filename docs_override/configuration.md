...
See [the Code documentation]({% link docs_override/ui-components/code/index.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({% link docs_override/navigation/main/external.md %}) for more details.
...
See [Customization]({% link docs_override/customization.md %}) for more information.
...
See [Callouts]({% link docs_override/ui-components/callouts.md %}) for more information.
