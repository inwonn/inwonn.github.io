...
By default, links to all pages appear in the main navigation at the top level, ordered alphabetically by their titles. By adding further fields to the front matter of individual pages, you can [change their order]({% link docs_override/navigation/main/order.md %}), [exclude pages]({% link docs_override/navigation/main/exclude.md %}), and change their [parent pages]({% link docs_override/navigation/main/levels.md %}).
