...
[X]: {% link docs_override/navigation/main/x.md %}
[XS]: {% link docs_override/navigation/main/xs.md %}
[XT]: {% link docs_override/navigation/main/xt.md %}
[XU]: {% link docs_override/navigation/main/xu.md %}
[Y]: {% link docs_override/navigation/main/y.md %}
[YS]: {% link docs_override/navigation/main/ys.md %}
[YT]: {% link docs_override/navigation/main/yt.md %}
[YU]: {% link docs_override/navigation/main/yu.md %}
